package libraries; /******************************************************************************
 *  Compilation:  javac libraries.StdRandom.java
 *  Execution:    java libraries.StdRandom
 ...
 *
 *  % java libraries.StdRandom 5 1316600616575
 *  seed = 1316600616575
 *  96 60.17070  true 8.72821  0 
 *  79 32.01607  true 8.58159  0 
 *  81 59.49065  true 9.10423  1 
...
/**
 *  The {@code libraries.StdRandom} class provides static methods for generating
...
//        StdOut.println("seed = " + libraries.StdRandom.getSeed());
//        for (int i = 0; i < n; i++) {
